...
proto_openconnect_setup() {
	...
	json_get_vars server port interface username serverhash authgroup usergroup password password2 token_mode token_secret token_script os csd_wrapper mtu juniper advanced_options form_entry
	...
	[ -n "$advanced_options" ] && append_args "$advanced_options"
